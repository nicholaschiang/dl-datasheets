...
def debug_print(msg):
    """ Debug logging function at the INFO level. """
    return debug_print_info(msg)


def debug_print_level(level, msg):
    """
    Logs a debug message and prints it out to standard output stream.
    ...
    if not should_log:
        return
    # Color the log level prefixes. See https://en.wikipedia.org/wiki/ANSI_escape_code#Colors for ANSI color codes.
...
def stdout_print(msg):
    """
    Prints given message as is without any extra new lines.
    """
